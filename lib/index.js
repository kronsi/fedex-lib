...
function FedEx(args) {
  ...
  function buildRatesRequest(data, options, resource, callback) {
    soap.createClient(path.join(__dirname,  'wsdl', resource.wsdl), {endpoint: $scope.hosts[$scope.options.environment] + resource.path}, function(err, client) {
      ...
      client.getRates(params, function(err, result, originalReply) {        
        if($scope.options.debug) {          
  ...
  function buildShipRequest(data, options, resource, callback) {
    soap.createClient(path.join(__dirname,  'wsdl', resource.wsdl), {endpoint: $scope.hosts[$scope.options.environment] + resource.path}, function(err, client) {
      ...
      client.processShipment(params, function(err, result, originalReply) {        
        if($scope.options.debug) {          
          switch( $scope.options.debugOutput ){
            case "json":
              parser.parseString(client.lastRequest, {explicitArray: false}, function(err, debug) {                
  ...
  function buildPickupRequest(data, options, resource, callback) {
    soap.createClient(path.join(__dirname,  'wsdl', resource.wsdl), {endpoint: $scope.hosts[$scope.options.environment] + resource.path}, function(err, client) {
      ...
      var params = generateAuthentication(data, resource, options);
      client.createPickup(params, function(err, result, originalReply) {
        if($scope.options.debug) {          
          switch( $scope.options.debugOutput ){
            case "json":
              parser.parseString(client.lastRequest, {explicitArray: false}, function(err, debug) {                
  ...
  function buildTrackingRequest(data, options, resource, callback) {
    soap.createClient(path.join(__dirname,  'wsdl', resource.wsdl), {endpoint: $scope.hosts[$scope.options.environment] + resource.path}, function(err, client) {
      ...
      client.track(params, function(err, result, originalReply) {
        if($scope.options.debug) {          
          switch( $scope.options.debugOutput ){
            case "json":
              parser.parseString(client.lastRequest, {explicitArray: false}, function(err, debug) {                
  ...
  function buildServiceAvailabilityRequest(data, options, resource, callback) {
    ...
    soap.createClient(path.join(__dirname,  'wsdl', resource.wsdl), {endpoint: $scope.hosts[$scope.options.environment] + resource.path}, function(err, client) {
      ...
      client.serviceAvailability(params, function(err, response, originalReply){
        if($scope.options.debug) {          
          switch( $scope.options.debugOutput ){
            case "json":
              parser.parseString(client.lastRequest, {explicitArray: false}, function(err, debug) {                
  ...
  function buildAddressValidationRequest(data, options, resource, callback) {
    ...
    soap.createClient(path.join(__dirname,  'wsdl', resource.wsdl), {endpoint: $scope.hosts[$scope.options.environment] + resource.path}, function(err, client) {
      ...
      client.addressValidation(params, function(err, result, originalReply) {
        if($scope.options.debug) {          
          switch( $scope.options.debugOutput ){
            case "json":
              parser.parseString(client.lastRequest, {explicitArray: false}, function(err, debug) {                
  ...
  function buildGroundCloseRequest(data, options, resource, callback) {
    ...
    soap.createClient(path.join(__dirname,  'wsdl', resource.wsdl), {endpoint: $scope.hosts[$scope.options.environment] + resource.path}, function(err, client) {
      ...
      client.groundClose(params, function(err, result, originalReply) {
        if($scope.options.debug) {          
          switch( $scope.options.debugOutput ){
            case "json":
              parser.parseString(client.lastRequest, {explicitArray: false}, function(err, debug) {                
  ...
  function buildSmartPostCloseRequest(data, options, resource, callback) {
    ...
    soap.createClient(path.join(__dirname,  'wsdl', resource.wsdl), {endpoint: $scope.hosts[$scope.options.environment] + resource.path}, function(err, client) {
      ...
      client.smartPostClose(params, function(err, result, originalReply) {
        if($scope.options.debug) {          
          switch( $scope.options.debugOutput ){
            case "json":
              parser.parseString(client.lastRequest, {explicitArray: false}, function(err, debug) {                
  ...
  function buildDeleteShipmentRequest(data, options, resource, callback) {
    soap.createClient(path.join(__dirname,  'wsdl', resource.wsdl), {endpoint: $scope.hosts[$scope.options.environment] + resource.path}, function(err, client) {
      ...
      client.deleteShipment(params, function(err, result, originalReply) {
        if($scope.options.debug) {          
          switch( $scope.options.debugOutput ){
            case "json":
              parser.parseString(client.lastRequest, {explicitArray: false}, function(err, debug) {                
  ...
  var resources = {
    rates: {f: buildRatesRequest, r: handleRatesResponse, wsdl: 'RateService_v31.wsdl', path: '/web-services', version: {ServiceId: 'crs', Major: 31, Intermediate: 0, Minor: 0}},
    ship: {f: buildShipRequest, r: handleShipResponse, wsdl: 'ShipService_v28.wsdl', path: '/web-services', version: {ServiceId: 'ship', Major: 28, Intermediate: 0, Minor: 0}},
    pickup: {f: buildPickupRequest, r: handlePickupResponse, wsdl: 'PickupService_v23.wsdl', path: '/web-services', version: {ServiceId: 'disp', Major: 23, Intermediate: 0, Minor: 0}},
    ...
    deleteshipment: {f: buildDeleteShipmentRequest, r: handleDeleteShipmentResponse, wsdl: 'ShipService_v28.wsdl', path: '/web-services', version: {ServiceId: 'ship', Major: 28, Intermediate: 0, Minor: 0}},
