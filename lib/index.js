...
function FedEx(args) {
  ...
  var resources = {
    ...
    deleteshipment: {f: buildDeleteShipmentRequest, r: handleDeleteShipmentResponse, wsdl: 'ShipService_v26.wsdl', path: '/web-services', version: {ServiceId: 'ship', Major: 26, Intermediate: 0, Minor: 0}},
